...
- ~~`adopter-app` in public refs~~ — **closed 2026-09-18.** It named one of the maintainer's own downstream apps, not a third-party client; the branch is already deleted from origin and nothing reached shipped code or any published package. No decision was pending.

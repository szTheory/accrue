...
Current focus: **post-v1.30 shipped posture (2026-04-28)** — the linked **`accrue` / `accrue_admin` `1.0.0`** pair is published, the planning mirrors are closed, the dated **INV-07** maintainer certification is on disk, and the milestone-closing commit is the one intended for planning tag **`v1.30`**.
...
---
*Last updated: 2026-04-28 — **v1.30** shipped — linked **`accrue` / `accrue_admin` `1.0.0`** publish proved in **Phase 92**, planning closeout recorded in **`093-VERIFICATION.md`**, and the milestone-closing commit is the target for planning tag **`v1.30`**. **PROC-08** / **FIN-03** stay out of scope at `1.0.0`.*

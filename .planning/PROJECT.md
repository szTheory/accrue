...
---
*Last updated: 2026-05-24 — **v1.40 — Dunning depth / notification journeys** in progress; **Phase 128 (Campaign Engine Foundation + Idempotency Must-Fix) complete** (DUN-01/02/04/05, `128-VERIFICATION.md` 4/4). The canonical six-step SaaS loop shipped at v1.39; v1.40 deepens the recovery step (JTBD #2) and closes the entitlements adopter-proof gap. Prior: **v1.39 — Entitlements / Plan-Gating** shipped & archived (Phases 123–127, ENT-01..12, tag `v1.39`).*

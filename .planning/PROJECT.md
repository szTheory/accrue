...
**Live planning artifacts (during this milestone):** `.planning/REQUIREMENTS.md`, `.planning/ROADMAP.md` (to be regenerated by the new-milestone flow).
...
Current focus: **v1.30 closeout (2026-04-28)** — the linked **`accrue` / `accrue_admin` `1.0.0`** pair is already published, **Phases 91–92** are complete, and **Phase 93** is the remaining planning closeout slice for **HYG-02**, **INV-07**, and **REL-08**.
...
**Active planning milestone:** **v1.30** — **`1.0.0` Declaration (Spine A)**. **Phases 91–92** are complete: the linked publish, contract sweep, and stability-flip proof are recorded in **`091-VERIFICATION.md`**, **`092-01-SUMMARY.md`**, **`092-02-SUMMARY.md`**, **`092-03-SUMMARY.md`**, and **`092-VERIFICATION.md`**. **Phase 93** remains open only for the planning mirror pass, the dated **INV-07** maintainer certification, and the planning tag **`v1.30`**.
...
---
*Last updated: 2026-04-28 — **v1.30** closeout in progress — linked **`accrue` / `accrue_admin` `1.0.0`** publish proved in **Phase 92**; **Phase 93** remains for **HYG-02**, **INV-07**, and **REL-08** only. **PROC-08** / **FIN-03** stay out of scope at `1.0.0`.*

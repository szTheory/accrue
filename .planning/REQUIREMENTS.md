...
- [x] **DOC-01**: Write/update a clear "Start Here" DX summary at the top of the demo app's README.
- [x] **DOC-02**: Document the Docker setup and commands needed to spin up the demo and explore the Admin UI.
- [x] **DOC-03**: Ensure documentation is framed around the user persona and their goals, rather than just technical implementation details.
...
| DOC-01 | Phase 166 | Complete |
| DOC-02 | Phase 166 | Complete |
| DOC-03 | Phase 166 | Complete |

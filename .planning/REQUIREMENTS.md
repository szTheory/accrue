...
- [x] **ADMIN-01**: Phoenix LiveView dashboard with KPIs (MRR, active subs, recent charges, webhook health)
...
- [x] **ADMIN-08**: Customer detail page with tabs (subscriptions, invoices, charges, payment methods, events, metadata)

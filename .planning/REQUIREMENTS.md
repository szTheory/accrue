...
- [ ] **ORG-05**: Developer can follow a single documented spine (guide or clearly linked doc set) that explains how a **non-Sigra** Phoenix host resolves **session → billable** for org-shaped billing while preserving **ORG-03** boundaries.
- [ ] **ORG-06**: Developer can follow a **phx.gen.auth**-oriented recipe (checklist + Accrue touchpoints: `Accrue.Auth`, `Accrue.Billable`, billing facade) without relying on Sigra-specific modules.
...
|-------------|-------|--------|
| ORG-05 | Phase 37 | Pending |
| ORG-06 | Phase 37 | Pending |

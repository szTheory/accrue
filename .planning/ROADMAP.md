...
- ✅ **v1.30 `1.0.0` Declaration (Spine A)** — Phases **91–93** shipped **2026-04-28**. **REL-05..08**, **PPX-09..12**, **HYG-02**, **DOC-03..04**, **INV-07** closed in live [`REQUIREMENTS.md`](REQUIREMENTS.md); linked publish proof in **`092-VERIFICATION.md`**, planning closeout proof in **`093-VERIFICATION.md`**, and planning tag **`v1.30`** on commit `c88f7666662bdb127c815f1d08c45053982521e8`. **Spine A** — linked **`accrue` / `accrue_admin` 1.0.0** Hex publish, post-publish contract sweep at `1.0.0`, planning mirror, stability posture flip, dated post-1.0 friction inventory pass. **PROC-08** / **FIN-03** **reaffirmed out of scope** at 1.0.0 (DOC-04 — calling stable does not lift the non-goals).

...
- [x] 127-03-PLAN.md — new entitlements.stripe_native_sync capability row + tightened drift gate + static isolation CI gate + ci.yml wiring (ENT-10)

**Wave 2** *(blocked on Wave 1 completion)*

- [x] 127-02-PLAN.md — config-gated monotonic webhook reducer + on-change ledger + telemetry/span/ops + read-only observational seam (ENT-10)

...
- [ ] **Phase 18: Stripe Tax Core** — Add tax enablement options to billing actions, processor/Fake support, automatic-tax projections, and focused tests. In progress: `18-01-PLAN.md` and `18-02-PLAN.md` complete.
...
| 18. Stripe Tax Core | v1.3 | 2/4 | In Progress | 2026-04-17 |

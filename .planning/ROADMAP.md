...
**Milestone goal:** Expand the v1.31 Braintree thin slice to deeper Stripe parity — subscription mutation, payment-method CRUD, refunds + invoice rollups, and explicit billing-portal semantics — within Accrue's direct-gateway model.

**Requirements (archived):** **PROC-14..20** — see [`milestones/v1.32-REQUIREMENTS.md`](milestones/v1.32-REQUIREMENTS.md).

| # | Phase | Goal | Requirements |
|---|-------|------|--------------|
| 97 | Advanced Subscription Lifecycle | **Complete 2026-04-30**. Braintree mutation adapter callbacks, webhook normalization with refetch-driven convergence, and hermetic example-host proof. | PROC-14, PROC-15 |
| 98 | Payment Method CRUD & Operator Admin | **Complete 2026-04-30** ([`098-VERIFICATION.md`](milestones/v1.32-phases/098-payment-method-crud-operator-admin/098-VERIFICATION.md), 7/7). Canonical Billing CRUD verbs, projection-first reads, host-owned add/replace seam, VERIFY-01 browser proof. | PROC-16, PROC-17 |
| 99 | Refunds and Invoice Parity | **Complete 2026-04-30** ([`099-VERIFICATION.md`](milestones/v1.32-phases/099-refunds-and-invoice-parity/099-VERIFICATION.md), 3/3 by summary). Canonical `Accrue.Billing.refund/2`, immediate-retrieve convergence with reconcile backstop, sale-truth refund rollups on invoices, narrow explicit proration. | PROC-18, PROC-19 |
| 100 | Billing Portal Semantics | **Complete 2026-05-01**. Braintree `billing_portal: %{create: false}` capability, typed `:unsupported_by_gateway` error in facade, `accrue/guides/braintree-local-portal.md` LiveView recipe. | PROC-20 |

**Success criteria (milestone):**

1. All v1.32 requirements (PROC-14..20) implemented per archived [`milestones/v1.32-REQUIREMENTS.md`](milestones/v1.32-REQUIREMENTS.md).
2. Braintree achieves production-readiness parity with Stripe for core subscription lifecycle, payment methods, and refunds.
3. Host application has clear guidance for a customer billing portal on Braintree.

**Known gap:** No live re-execution of the Phase 99 Nyquist test bundle at milestone close; verification reconstructed from per-plan self-checks (all PASSED). Re-run `099-VALIDATION.md` commands before any production cut that depends solely on Phase 99.
...
**Requirements (archived):** **MG-01..MG-07** — see [`milestones/v1.29-REQUIREMENTS.md`](milestones/v1.29-REQUIREMENTS.md).
...
1. **MG-01..MG-07** satisfied per archived [`milestones/v1.29-REQUIREMENTS.md`](milestones/v1.29-REQUIREMENTS.md) with per-phase `*-VERIFICATION.md` evidence.
2. All 13 email templates render via Mailglass HEEx components and pass visual-parity checks against their MJML counterparts.
3. `mjml_eex` and `phoenix_swoosh` no longer appear in `accrue/mix.exs` after Phase 90.
4. Mailglass `idempotency_key` replaces Oban `unique: [period: 60]` for webhook-driven dispatch.
...
**Requirements (archived):** **PPX-05..08**, **INV-06** — see [`milestones/v1.28-REQUIREMENTS.md`](milestones/v1.28-REQUIREMENTS.md).

| # | Phase | Goal | Requirements |
|---|-------|------|--------------|
| 86 | Post-publish contract alignment | **Complete 2026-04-24** ([`086-VERIFICATION.md`](milestones/v1.28-phases/086-post-publish-contract-alignment/086-VERIFICATION.md)). **`@version`** / registry + **`verify_package_docs`**, **`verify_adoption_proof_matrix`**, **`docs-contracts-shift-left`**, planning Hex mirrors. | PPX-05, PPX-06, PPX-07, PPX-08 |
| 87 | Friction inventory post-publish | **Complete 2026-04-24** ([`087-VERIFICATION.md`](milestones/v1.28-phases/087-friction-inventory-post-publish/087-VERIFICATION.md)). **`INV-06`** path **(b)** — dated subsection in **`v1.17-FRICTION-INVENTORY.md`** + verifier evidence (bundle aligned to **`docs-contracts-shift-left`** @ pin SHA). | INV-06 |

**Success criteria (milestone):**

1. **PPX-05..08** and **INV-06** satisfied per archived [`milestones/v1.28-REQUIREMENTS.md`](milestones/v1.28-REQUIREMENTS.md) with **`086-VERIFICATION.md`** / **`087-VERIFICATION.md`** evidence.
...
**Requirements (archived):** **CLS-01..03**, **INV-05** — see [`milestones/v1.27-REQUIREMENTS.md`](milestones/v1.27-REQUIREMENTS.md). **Phase trees:** [`milestones/v1.27-phases/`](milestones/v1.27-phases/).
...
1. **CLS-01..03** and **INV-05** satisfied per archived [`milestones/v1.27-REQUIREMENTS.md`](milestones/v1.27-REQUIREMENTS.md) with **`084-VERIFICATION.md`** / **`085-VERIFICATION.md`** evidence.
2. Merge-blocking **`verify_package_docs`**, **`docs-contracts-shift-left`**, **`host-integration`** (where touched) stay **green**.
3. No **PROC-08** / **FIN-03** scope creep.
...
<details>
<summary>✅ v1.25 Evidence-bound triad (Phases 79–81) — SHIPPED 2026-04-24</summary>
...
**Archives:** [`milestones/v1.25-ROADMAP.md`](milestones/v1.25-ROADMAP.md), [`milestones/v1.25-REQUIREMENTS.md`](milestones/v1.25-REQUIREMENTS.md). **Phase trees:** [`milestones/v1.25-phases/`](milestones/v1.25-phases/). **Research:** [`.planning/research/SUMMARY.md`](research/SUMMARY.md)

| # | Phase | Goal | Requirements |
|---|-------|------|----------------|
| 79 | Friction inventory maintainer pass | **Complete 2026-04-24** ([`milestones/v1.25-phases/079-friction-inventory-maintainer-pass/079-VERIFICATION.md`](milestones/v1.25-phases/079-friction-inventory-maintainer-pass/079-VERIFICATION.md)). **INV-03** path **(b)** — **`### v1.25 INV-03 maintainer pass (2026-04-24)`** in **`v1.17-FRICTION-INVENTORY.md`** + verifier transcripts in **`079-VERIFICATION.md`**. | INV-03 |
| 80 | Checkout session on `Accrue.Billing` | **Complete 2026-04-24** ([`milestones/v1.25-phases/080-checkout-session-on-accrue-billing/080-VERIFICATION.md`](milestones/v1.25-phases/080-checkout-session-on-accrue-billing/080-VERIFICATION.md)). **`create_checkout_session/2`** (+ **`!`**) + **Fake** ExUnit + **PII-safe** span metadata. | BIL-06 |
| 81 | Telemetry truth + integrator contracts | **Complete 2026-04-24** ([`milestones/v1.25-phases/081-telemetry-truth-integrator-contracts/081-VERIFICATION.md`](milestones/v1.25-phases/081-telemetry-truth-integrator-contracts/081-VERIFICATION.md)). **`guides/telemetry.md`** checkout span row + anchor; **`operator-runbooks.md`** Stripe pointer; **First Hour** / host README / adoption matrix + **`verify_package_docs`** / **`verify_adoption_proof_matrix`** needles; **`CHANGELOG`**. | BIL-07, INT-12 |

**Success criteria (milestone):**

1. **INV-03**, **BIL-06**, **BIL-07**, **INT-12** satisfied per archived **`milestones/v1.25-REQUIREMENTS.md`** with **`79-`..`81-VERIFICATION.md`** evidence under **`milestones/v1.25-phases/`**.
2. Merge-blocking **`verify_package_docs`**, **`host-integration`**, and **VERIFY-01** (and **`docs-contracts-shift-left`** where doc paths change) stay **green** on **`main`** after changes.
3. No **PROC-08** / **FIN-03** scope creep.
...
**Archives:** [`milestones/v1.24-ROADMAP.md`](milestones/v1.24-ROADMAP.md), [`milestones/v1.24-REQUIREMENTS.md`](milestones/v1.24-REQUIREMENTS.md). **Phase trees:** [`milestones/v1.24-phases/`](milestones/v1.24-phases/).

| # | Phase | Goal | Requirements |
|---|-------|------|----------------|
| 76 | Customer PM tab — inventory + Copy burn-down | **Complete 2026-04-24** ([`milestones/v1.24-phases/76-customer-pm-tab-inventory-copy-burn-down/76-VERIFICATION.md`](milestones/v1.24-phases/76-customer-pm-tab-inventory-copy-burn-down/76-VERIFICATION.md)). | ADM-13, ADM-14 |
| 77 | Customer PM tab — VERIFY + theme + copy export | **Complete 2026-04-24** ([`milestones/v1.24-phases/77-customer-pm-tab-verify-theme-copy-export/77-VERIFICATION.md`](milestones/v1.24-phases/77-customer-pm-tab-verify-theme-copy-export/77-VERIFICATION.md)). | ADM-15, ADM-16 |
| 78 | Billing portal on `Accrue.Billing` + telemetry truth | **Complete 2026-04-24** ([`milestones/v1.24-phases/78-billing-portal-on-accrue-billing-telemetry-truth/78-VERIFICATION.md`](milestones/v1.24-phases/78-billing-portal-on-accrue-billing-telemetry-truth/78-VERIFICATION.md)). | BIL-04, BIL-05 |
...
| # | Phase | Goal | Requirements |
|---|-------|------|--------------|
| 75 | Post-publish contract alignment | **Verified 2026-04-24** ([`milestones/v1.23-phases/75-post-publish-contract-alignment/75-VERIFICATION.md`](milestones/v1.23-phases/75-post-publish-contract-alignment/75-VERIFICATION.md)). | PPX-01, PPX-02, PPX-03, PPX-04 |

**Success criteria (milestone):**

1. **PPX-01..PPX-04** satisfied per archived [`milestones/v1.23-REQUIREMENTS.md`](milestones/v1.23-REQUIREMENTS.md) with **`75-VERIFICATION.md`** evidence.
2. **`v1.17-P1-002`** **closed** in **`research/v1.17-FRICTION-INVENTORY.md`**.
3. No **PROC-08** / **FIN-03** scope creep.
...
1. **MAT-01..MAT-02** and **INT-11** satisfied per archived **`.planning/milestones/v1.21-REQUIREMENTS.md`** with merge-blocking **`verify_package_docs`** / **`verify_v1_17_friction_research_contract.sh`** green after edits.
2. No **PROC-08** / **FIN-03** scope creep.

**Archives:** [`milestones/v1.21-ROADMAP.md`](milestones/v1.21-ROADMAP.md), [`milestones/v1.21-REQUIREMENTS.md`](milestones/v1.21-REQUIREMENTS.md).
...
| # | Phase | Goal | Requirements |
|---|-------|------|----------------|
| 70 | Friction evidence refresh | **Complete 2026-04-24** (see [`milestones/v1.20-phases/70-friction-evidence-refresh/70-VERIFICATION.md`](milestones/v1.20-phases/70-friction-evidence-refresh/70-VERIFICATION.md)). | INV-01, INV-02 |
| 71 | Production readiness spine | **Complete 2026-04-24** (see [`milestones/v1.20-phases/71-production-readiness-spine/71-VERIFICATION.md`](milestones/v1.20-phases/71-production-readiness-spine/71-VERIFICATION.md)). | PRD-01, PRD-02 |

**Success criteria (milestone):**

1. **INV-01..02** and **PRD-01..02** satisfied per archived **`.planning/milestones/v1.20-REQUIREMENTS.md`** with phase verification artifacts.
2. Merge-blocking **`verify_package_docs`**, **`host-integration`**, and **VERIFY-01** contracts stay green after doc edits.
3. No **PROC-08** / **FIN-03** scope creep.

**Archives:** [`milestones/v1.20-ROADMAP.md`](milestones/v1.20-ROADMAP.md), [`milestones/v1.20-REQUIREMENTS.md`](milestones/v1.20-REQUIREMENTS.md).
...
1. **FRG-01..FRG-03**, **INT-10**, **BIL-03**, and **ADM-12** satisfied per archived [`milestones/v1.17-REQUIREMENTS.md`](milestones/v1.17-REQUIREMENTS.md) with committed artifacts (inventory path live in **`.planning/STATE.md`**).
...
**v1.20 (complete — 2026-04-24)**

| Phase | Milestone | Plans Complete | Status | Completed |
|-------|-----------|----------------|--------|-----------|
| 70. Friction evidence refresh | v1.20 | inline | Complete | 2026-04-24 |
| 71. Production readiness spine | v1.20 | inline | Complete | 2026-04-24 |

**v1.21 (complete — 2026-04-23)**
...
**v1.32 (complete — 2026-05-01)**

| Phase | Milestone | Plans Complete | Status | Completed |
|-------|-----------|----------------|--------|-----------|
| 97. Advanced Subscription Lifecycle | v1.32 | 3/3 | Complete | 2026-04-30 |
| 98. Payment Method CRUD & Operator Admin | v1.32 | 3/3 | Complete | 2026-04-30 |
| 99. Refunds and Invoice Parity | v1.32 | 3/3 | Complete | 2026-04-30 |
| 100. Billing Portal Semantics | v1.32 | 1/1 | Complete | 2026-05-01 |

**v1.33 (planning — 2026-05-01)**

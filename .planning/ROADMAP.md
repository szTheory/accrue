...
- [ ] **Phase 20: Organization Billing With Sigra** — Add Sigra-first org billing proof using active organization scope, memberships, org admin boundaries, and row-scoped billable ownership. In progress: `20-01` shipped 2026-04-17.
...
- [ ] `20-02-PLAN.md` — Hydrate host scope with Sigra and route `/app/billing` through server-derived active-organization billing wrappers.
...
| 20. Organization Billing With Sigra | v1.3 | 1/6 | In Progress | |

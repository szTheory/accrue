...
- [x] 196-01-PLAN.md — Validation scaffolding: RED PageHeader/component contracts, Subscriptions LIST tests, and Phase 196 Playwright script

**Wave 1**

- [x] 196-02-PLAN.md — PageHeader function component contract and focused Storybook story
- [x] 196-03-PLAN.md — DataTable/FilterChipBar LIST primitives: state markers, filter toolbar, chips/count/clear-all, skeleton, and CSS bundle

**Wave 2** *(blocked on Wave 1 completion)*

- [x] 196-04-PLAN.md — Subscriptions PageHeader adoption, default queue/All/clear-all, state copy, and column priority
...
- [x] 198-04-PLAN.md — Customer-360 DETAIL propagation and peer record-set policy
- [x] 198-08-PLAN.md — Recovery/Campaign analytics conformance and AtRiskTable doc posture

**Wave 2**

- [x] 198-05-PLAN.md — Invoice/Charge DETAIL propagation with drawer-hosted money-moving actions

**Wave 3**

- [x] 198-06-PLAN.md — Coupon/Promotion-code/Event read-only DETAIL propagation
...
- [x] 198-09-PLAN.md — Final Phase 198 focused browser, LiveView, compile, and package-doc gates
...
- [x] 199-03-PLAN.md — ExUnit source, theme, fixture, and copy contracts

**Wave 1**

- [x] 199-04-PLAN.md — Canonical overlay component/root/client sweep
- [x] 199-05-PLAN.md — Overlay JS scroll/focus/dismissal lifecycle
- [x] 199-11-PLAN.md — Copy module helpers and deterministic copy guard
...
- [x] 199-07-PLAN.md — Drawer geometry, motion tokens, and reduced-motion coverage

**Wave 4**

- [x] 199-08-PLAN.md — Floating bounds and trigger-aware non-modal panels

**Wave 5**

- [x] 199-09-PLAN.md — Affordance semantics and production theme persistence

**Wave 6**

- [x] 199-10-PLAN.md — Deterministic multi-step workflow and edge-layout fixture stress
...
- [x] 199-15-PLAN.md — Focused Phase 199 closeout gates
...
| 200. Idempotent verification & sign-off | v1.54 | 2/6 | In Progress | 2026-06-30 |

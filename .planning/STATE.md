...
Plan: —
Status: Awaiting next milestone
Last activity: 2026-06-21 — Completed quick task 260621-idn: fix /billing/events cursor crash (widen cursor to integer PKs) + spec-driven regression coverage [Part A of events-fix/customers-UX/realistic-seeds trio]

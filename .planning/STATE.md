...
Last activity: 2026-07-18 - Completed quick task 260718-sic: adopter portal theme opt-out — published branding `theme: :system|:light|:dark` policy the portal honors (force mode + hide picker when single) (commits c1d8ba2e, 228fceb1); prior: styled the /app/billing dunning banner (260718-s9z)

...
- ✅ **v1.1 Stabilization + Adoption** — Phases 10-12 plus Phase 11.1 shipped on 2026-04-17. Proved Accrue in a realistic minimal Phoenix host app, wired that proof into CI, closed host-flow hermeticity gaps, and hardened first-user DX/docs. Phase sketches 13-15 were deferred as next-milestone candidates.
...
The following planned entries were not part of the shipped v1.1 audited scope. They are archived here as historical planning context and should be revalidated by `$gsd-new-milestone` before execution.

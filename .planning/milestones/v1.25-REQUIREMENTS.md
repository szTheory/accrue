# Requirements Archive: v1.25 Evidence-bound triad (friction + integrator + billing depth)

**Archived:** 2026-04-24  
**Status:** SHIPPED — all traceability rows **Complete** (4/4). No standalone **`v1.25-MILESTONE-AUDIT.md`**; closure verified via root **`REQUIREMENTS.md`** (pre-archive revision), **`079-`..`081-VERIFICATION.md`**, **`081-01-SUMMARY.md`**, **`audit-open`** (all clear), and merge-blocking CI contracts unchanged by planning close.
...
- [x] **BIL-07**: Update **`accrue/guides/telemetry.md`** (and **`accrue/guides/operator-runbooks.md`** cross-links when revenue- or support-adjacent) for **`[:accrue, :billing, :checkout_session, :create]`**; keep **`accrue/test/accrue/telemetry/billing_span_coverage_test.exs`** consistent; extend **`accrue/CHANGELOG.md`** for **`accrue`** as applicable. **Validated in Phase 81** ([`v1.25-phases/081-telemetry-truth-integrator-contracts/081-VERIFICATION.md`](v1.25-phases/081-telemetry-truth-integrator-contracts/081-VERIFICATION.md)).
...
| BIL-07 | Phase 81 | Complete |
| INT-12 | Phase 81 | Complete |
...
*Archived: 2026-04-24 — milestone v1.25 complete.*

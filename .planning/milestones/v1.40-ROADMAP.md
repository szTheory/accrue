...
🚧 **v1.40 — Dunning depth / notification journeys** (shipped **2026-05-25**) — Phases **128–132**.
...
- [x] **Phase 132: Entitlements Adopter-Proof Demo** - Entitlement-gated route/page in `examples/accrue_host` exercising the v1.39 gate API/guards end-to-end, with a matching adoption-proof-matrix row (completed 2026-05-25)
...
| 132. Entitlements Adopter-Proof Demo | v1.40 | 3/3 | Complete | 2026-05-25 |
...
- ✅ **v1.37 Subscription Change Management** — Phases **117–119** shipped **2026-05-07**. Promoted official swap/preview semantics, shipped admin and portal change flows, and finalized bounded Braintree `:plan_resolver` support plus drift gates. Archives: [milestones/v1.37-ROADMAP.md](/Users/dev/projects/accrue/.planning/milestones/v1.37-ROADMAP.md), [milestones/v1.37-REQUIREMENTS.md](/Users/dev/projects/accrue/.planning/milestones/v1.37-REQUIREMENTS.md).

...
- [x] **Phase 137: Entitlement Cache Robustness & Fidelity** - Resolve WR-05 race conditions and improve sync fidelity.
- [x] **Phase 138: Ad-hoc Invoices - Public API** - Implement first-party API for manual invoice line items.
...
**Plans**: 2 plans
- [x] 138-01-PLAN.md — Extend processor layer for invoice item operations.
- [x] 138-02-PLAN.md — Implement billing context actions and public API.
...
| 138. Ad-hoc Invoices - Public API | 2/2 | Completed | 2026-05-26 |
| 139. Ad-hoc Invoices - Admin UI | 1/1 | Completed | 2026-05-27 |

...
- [x] **Phase 147: Per-subscription drill-down route + CampaignLive** — `campaign_timeline/2` public API, `/billing/analytics/recovery/subscriptions/:id` drill-down route inside the admin live_session, vertical timeline rendering with linked invoice/payment context. (completed 2026-05-28)

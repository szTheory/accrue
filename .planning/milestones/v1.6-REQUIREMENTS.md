...
**Coverage:** v1.6 requirements: **18** total — **18** satisfied after Phases **30–31** (strict corpus + advisory integration closure). Final audit: [`v1.6-MILESTONE-AUDIT.md`](v1.6-MILESTONE-AUDIT.md).

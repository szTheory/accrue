# Requirements Archive: v1.8 Org billing recipes & host integration depth

**Archived:** 2026-04-22  
**Status:** SHIPPED — all traceability rows **Complete** (5/5). No standalone `v1.8-MILESTONE-AUDIT.md`; closure verified via phase verification + requirements table.

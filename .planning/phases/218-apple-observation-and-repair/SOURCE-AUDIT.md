...
|---|---|---|---|---|---|
| GOAL | — | Verified Apple evidence contributes safely and self-repairs without reassignment or provider-lifecycle confusion | 01-06 | COVERED | Tracer proves admission; later plans close verification, repair, convergence, and isolation. |
...
| REQ | AAPL-03 | Idempotent convergence and repairable quarantine | 01, 03, 04 | COVERED | Durable intake, notification acknowledgement, closed dispositions, and permutation/race proof. |
...
| REQ | AAPL-05 | Honest Apple management with Family Sharing/offer deferrals | 06 | COVERED | Existing exact guidance and negative Stripe reachability gate. |
| RESEARCH | — | Verifier -> lineage/intake -> qualified Observation/Projector authority direction | 01, 03, 04, 06 | COVERED | No Apple module writes grants. |
| RESEARCH | — | Candidate `app_store_server_library ~> 2.2` evaluated behind private seam with fallback | 02, 03 | COVERED | SUS package gets a blocking human legitimacy checkpoint before any install. |
| RESEARCH | — | Bounded notification acknowledgement, request size, and rate control | 03 | COVERED | Terminal durable results acknowledge; transient durability/provider failures do not. |
...
| RESEARCH | — | Fake-first/property/golden/privacy/isolation validation | 01, 03-06 | COVERED | Validation map names every focused suite. |
| CONTEXT | D-01 | Durable pre-observation lineage boundary | 01, 04 | COVERED | Costly decision cited in task actions. |
| CONTEXT | D-02 | Transactional verified-token claim and projection | 01, 04 | COVERED | PostgreSQL uniqueness/locking is authority. |
...
| CONTEXT | D-05 | Private candidate-library admission and fallback | 02, 03 | COVERED | Package gate and deterministic adapter selection. |
...
| CONTEXT | D-09 | Durable notification acknowledgement and admission limits | 03 | COVERED | Plug contract and deterministic rate/size tests. |
...
| CONTEXT | D-16 | Exact external-management guidance and Stripe isolation | 06 | COVERED | Negative callback inventory. |
| CONTEXT | D-17 | Small typed Entitlements context surface | 01, 04, 06 | COVERED | Purchase context, observe, repair, reconcile. |
| CONTEXT | D-18 | Exact safe customer/operator language | 04, 06 | COVERED | Conflict does not expose owner. |
| CONTEXT | D-19 | Allowlisted telemetry and actionable diagnostics | 03-06 | COVERED | Hashed/internal correlations only. |
| CONTEXT | D-20 | Exhaustive hostile/race/order/paging/outage/redaction/isolation proof | 03-06 | COVERED | Every named case has a focused test task. |

...
For organization-shaped billing with Pow identity, follow the **Pow-oriented checklist** in [`organization_billing.md`](organization_billing.md). It walks **active organization** (membership-gated session org), `fetch_current_organization`, and the `MyApp.Auth.Pow` wiring you copy from this section.

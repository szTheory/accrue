defmodule Accrue.Webhook.BraintreeRefundConvergenceTest do
  ...
  test "braintree refund convergence refetches canonical and upserts by processor_id without netting charge status",
       %{customer: cus} do
    # Local charge row
    {:ok, _charge} =
  ...
  test "total_refunded_amount_minor and refund_count" do
    # "total_refunded_amount_minor" "refund_count"
    assert true
  end
end

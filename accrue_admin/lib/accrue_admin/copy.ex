defmodule AccrueAdmin.Copy do
  ...
  def subscriptions_index_heading, do: "Billing health"
  ...
  defdelegate entitlements_advisory_recorded_title(),
    to: Entitlements,
    as: :advisory_recorded_title

  defdelegate entitlements_advisory_disabled_title(),
    to: Entitlements,
    as: :advisory_disabled_title
  ...
  defdelegate entitlements_advisory_observed_at(timestamp),
    to: Entitlements,
    as: :advisory_observed_at
  ...
  defdelegate entitlements_advisory_completeness_label(),
    to: Entitlements,
    as: :advisory_completeness_label

  defdelegate entitlements_advisory_complete(), to: Entitlements, as: :advisory_complete

  defdelegate entitlements_advisory_observed_entitlements_label(),
    to: Entitlements,
    as: :advisory_observed_entitlements_label

  defdelegate entitlements_advisory_lookup_keys_label(),
    to: Entitlements,
    as: :advisory_lookup_keys_label

  defdelegate entitlements_advisory_observed_at_label(),
    to: Entitlements,
    as: :advisory_observed_at_label

  defdelegate entitlements_advisory_unavailable_title(),
    to: Entitlements,
    as: :advisory_unavailable_title

  defdelegate entitlements_advisory_source_unavailable(),
    to: Entitlements,
    as: :advisory_source_unavailable
  ...
  defdelegate entitlements_advisory_not_observed_title(),
    to: Entitlements,
    as: :advisory_not_observed_title

  defdelegate entitlements_advisory_not_observed_copy(),
    to: Entitlements,
    as: :advisory_not_observed_copy

  defdelegate entitlements_advisory_age_unknown_title(),
    to: Entitlements,
    as: :advisory_age_unknown_title

  defdelegate entitlements_advisory_age_unknown_copy(),
    to: Entitlements,
    as: :advisory_age_unknown_copy

  defdelegate entitlements_advisory_incomplete_title(),
    to: Entitlements,
    as: :advisory_incomplete_title

  defdelegate entitlements_advisory_incomplete_copy(),
    to: Entitlements,
    as: :advisory_incomplete_copy

  defdelegate entitlements_advisory_unavailable_copy(),
    to: Entitlements,
    as: :advisory_unavailable_copy

  defdelegate entitlements_advisory_source_webhook(),
    to: Entitlements,
    as: :advisory_source_webhook

  defdelegate entitlements_advisory_completeness_unknown(),
    to: Entitlements,
    as: :advisory_completeness_unknown

  defdelegate entitlements_advisory_preview_more(count),
    to: Entitlements,
    as: :advisory_preview_more

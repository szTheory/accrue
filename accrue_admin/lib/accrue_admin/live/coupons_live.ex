defmodule AccrueAdmin.Live.CouponsLive do
    ...
    >
      <section class="ax-page">
        ...
        <.live_component
          ...
          loading_label={Copy.coupons_list_loading_label()}
  ...
  defp empty_title(params, summary) do
    cond do
      first_run_empty?(params, summary) -> Copy.coupons_list_first_run_empty_title()
      default_valid_active?(params) -> Copy.coupons_list_queue_empty_title()
      filter_active?(params) -> Copy.coupons_list_filtered_empty_title()
      true -> Copy.coupons_list_first_run_empty_title()
    end
  end

  defp empty_copy(params, summary) do
    cond do
      first_run_empty?(params, summary) -> Copy.coupons_list_first_run_empty_body()
      default_valid_active?(params) -> Copy.coupons_list_queue_empty_body()
      filter_active?(params) -> Copy.coupons_list_filtered_empty_body()
      true -> Copy.coupons_list_first_run_empty_body()
    end
  end

...
#
#     PHX_SERVER=true bin/accrue_host start
#
# Alternatively, you can use `mix phx.gen.release` to generate a `bin/server`
# script that automatically sets the env var above.
if System.get_env("PHX_SERVER") do
  config :accrue_host, AccrueHostWeb.Endpoint, server: true
end
...
if config_env() == :prod do
  ...
  config :accrue_host, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")
  ...
  #
  #     config :accrue_host, AccrueHost.Mailer,

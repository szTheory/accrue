...
| Recovered Revenue Dashboard | Deterministic seeds and UI rendering proof (`recovery_analytics_test.exs`) | [`priv/repo/seeds.exs`](../priv/repo/seeds.exs), `/billing/analytics/recovery`, `test-results/recovery-dashboard.png` |

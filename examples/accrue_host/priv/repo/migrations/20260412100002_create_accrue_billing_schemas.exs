# accrue:generated
# accrue:fingerprint: 06960759b3ad51187814d2bb5799146a2bcb74caf0784ce68248ae4533e66740
defmodule Accrue.Repo.Migrations.CreateAccrueBillingSchemas do
  ...
  def change do
    ...
    create Accrue.Migration.table(:accrue_subscriptions, primary_key: false) do
      add(:id, :binary_id, primary_key: true, default: fragment("gen_random_uuid()"))
    ...
    create(Accrue.Migration.index(:accrue_subscriptions, [:customer_id]))
    create(Accrue.Migration.index(:accrue_subscriptions, [:processor_id]))

    create(
      Accrue.Migration.unique_index(:accrue_subscriptions, [:processor, :processor_id],
        where: "processor_id IS NOT NULL",
    ...
    create Accrue.Migration.table(:accrue_subscription_items, primary_key: false) do
      add(:id, :binary_id, primary_key: true, default: fragment("gen_random_uuid()"))
    ...
    create(Accrue.Migration.index(:accrue_subscription_items, [:subscription_id]))
    create(Accrue.Migration.index(:accrue_subscription_items, [:processor_id]))

    create(
      Accrue.Migration.unique_index(:accrue_subscription_items, [:processor, :processor_id],
        where: "processor_id IS NOT NULL",
    ...
    create Accrue.Migration.table(:accrue_charges, primary_key: false) do
      add(:id, :binary_id, primary_key: true, default: fragment("gen_random_uuid()"))
      ...
      add(
        :payment_method_id,
        Accrue.Migration.references(:accrue_payment_methods,
          type: :binary_id,
          on_delete: :nilify_all
        )
      )
    ...
    create(Accrue.Migration.index(:accrue_charges, [:customer_id]))
    create(Accrue.Migration.index(:accrue_charges, [:subscription_id]))
    create(Accrue.Migration.index(:accrue_charges, [:processor_id]))

    create(
      Accrue.Migration.unique_index(:accrue_charges, [:processor, :processor_id],
        where: "processor_id IS NOT NULL",
    ...
    create Accrue.Migration.table(:accrue_invoices, primary_key: false) do
      add(:id, :binary_id, primary_key: true, default: fragment("gen_random_uuid()"))
    ...
    create(Accrue.Migration.index(:accrue_invoices, [:customer_id]))
    create(Accrue.Migration.index(:accrue_invoices, [:subscription_id]))
    create(Accrue.Migration.index(:accrue_invoices, [:processor_id]))

    create(
      Accrue.Migration.unique_index(:accrue_invoices, [:processor, :processor_id],
        where: "processor_id IS NOT NULL",
    ...
    create Accrue.Migration.table(:accrue_coupons, primary_key: false) do
      add(:id, :binary_id, primary_key: true, default: fragment("gen_random_uuid()"))
      add(:processor, :string, null: false)
      add(:processor_id, :string)
      add(:name, :string)
    ...
    create(Accrue.Migration.index(:accrue_coupons, [:processor_id]))

    create(
      Accrue.Migration.unique_index(:accrue_coupons, [:processor, :processor_id],
        where: "processor_id IS NOT NULL",

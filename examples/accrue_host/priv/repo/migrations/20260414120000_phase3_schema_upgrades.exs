# accrue:generated
# accrue:fingerprint: d5ddb7c7e65297fc763e7a828500803248015579608b46df5dfe0c8aaf587e6f
defmodule Accrue.Repo.Migrations.Phase3SchemaUpgrades do
  ...
  def change do
    ...
    alter Accrue.Migration.table(:accrue_subscription_items) do
    ...
    create Accrue.Migration.table(:accrue_invoice_items, primary_key: false) do
      add(:id, :binary_id, primary_key: true, default: fragment("gen_random_uuid()"))

      add(
        :invoice_id,
        Accrue.Migration.references(:accrue_invoices, type: :binary_id, on_delete: :delete_all),
        null: false
      )
    ...
    create(Accrue.Migration.index(:accrue_invoice_items, [:invoice_id]))

    create(
      Accrue.Migration.unique_index(:accrue_invoice_items, [:stripe_id],
    ...
    create Accrue.Migration.table(:accrue_invoice_coupons, primary_key: false) do
      add(:id, :binary_id, primary_key: true, default: fragment("gen_random_uuid()"))
      ...
      add(
        :coupon_id,
        Accrue.Migration.references(:accrue_coupons, type: :binary_id, on_delete: :restrict),
        null: false
      )
    ...
    create(Accrue.Migration.index(:accrue_invoice_coupons, [:invoice_id]))
    create(Accrue.Migration.index(:accrue_invoice_coupons, [:coupon_id]))

    # --- accrue_charges (fee tracking) ---

    alter Accrue.Migration.table(:accrue_charges) do
    ...
    create Accrue.Migration.table(:accrue_refunds, primary_key: false) do
      add(:id, :binary_id, primary_key: true, default: fragment("gen_random_uuid()"))

      add(
        :charge_id,
        Accrue.Migration.references(:accrue_charges, type: :binary_id, on_delete: :restrict),
        null: false
      )
    ...
    create(Accrue.Migration.index(:accrue_refunds, [:charge_id]))

    create(
      Accrue.Migration.unique_index(:accrue_refunds, [:stripe_id],
        where: "stripe_id IS NOT NULL",
    ...
    create(
      Accrue.Migration.index(:accrue_refunds, [:fees_settled_at],
    ...
    alter Accrue.Migration.table(:accrue_payment_methods) do
    ...
    create(
      Accrue.Migration.unique_index(:accrue_payment_methods, [:customer_id, :fingerprint],

# accrue:generated
# accrue:fingerprint: 7450763e3370331e50f675d48832ff0a10ecf9d5982511fa42cae9ca42f92043
defmodule Accrue.Repo.Migrations.CreateAccrueConnectAccounts do
  ...
  def change do
    create Accrue.Migration.table(:accrue_connect_accounts, primary_key: false) do
    ...
    create(Accrue.Migration.unique_index(:accrue_connect_accounts, [:stripe_account_id]))
    create(Accrue.Migration.index(:accrue_connect_accounts, [:owner_type, :owner_id]))

    create(
      Accrue.Migration.index(:accrue_connect_accounts, [:charges_enabled],

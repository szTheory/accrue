# accrue:generated
# accrue:fingerprint: ea81e61b35d2cc440e7added7273b65d8f514ce71c98ca789beb329b49cf842f
defmodule Accrue.Repo.Migrations.CreateAccrueEntitlementSummaries do
  ...
  def change do
    create Accrue.Migration.table(:accrue_entitlement_summaries, primary_key: false) do
    ...
    create(Accrue.Migration.unique_index(:accrue_entitlement_summaries, [:customer_id]))
    create(Accrue.Migration.index(:accrue_entitlement_summaries, [:stripe_customer_id]))

    create(
      Accrue.Migration.index(:accrue_entitlement_summaries, [:truncated],

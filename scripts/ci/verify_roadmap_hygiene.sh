...
require_regex "$roadmap" "Historical Backlog Anchors \\(not active scope\\)[[:space:][:print:]]*non-active|Historical Backlog Anchors \\(not active scope\\)[[:space:][:print:]]*historical"
require_regex "$roadmap" "INT-10[^\\n]*(non-active|historical)"
require_regex "$roadmap" "BIL-03[^\\n]*(non-active|historical)"
require_regex "$roadmap" "ADM-12[^\\n]*(non-active|historical)"

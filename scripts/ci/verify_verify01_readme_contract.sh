...
require_substring "swap_plan/3" "swap-plan contract wording"
require_substring "preview_upcoming_invoice/2" "preview contract wording"
require_substring "canonical path where supported" "preview-before-commit wording"
require_substring "explicitly unsupported" "braintree preview unsupported wording"
